...
NODE_APP="start.js"
NODE_ARGUMENT=""
APP_DIR="/usr/local/bbq-pi"
PID_DIR="$APP_DIR/pid"
PID_FILE="$PID_DIR/app.pid"
LOG_DIR="/var/log"
LOG_FILE="$LOG_DIR/bbq-pi.log"
CONFIG_DIR="$APP_DIR"
PORT=0
...
# Default-Stop:      0 1 6
# Short-Description: start and stop bbq-pi
# Description: bbq-pi
### END INIT INFO
...
start_it() {
    ...
    PORT="$PORT" NODE_ENV="$NODE_ENV" NODE_CONFIG_DIR="$CONFIG_DIR" $NODE_EXEC "$APP_DIR/$NODE_APP" $NODE_ARGUMENT  1>>"$LOG_FILE" 2>&1 &
    echo $! > "$PID_FILE"
