...
var updateProbe = function (probe) {
	...
	var storeValue = function (timestamp, probe, value) {
		...
		displayStorage.temp[probe.channel] = value;
...
var updateDisplay = function () {
	...
	etobiShield.display.writeLine(6, stringPad(displayStorage.temp[0], '     ') + '        ' + stringPad(displayStorage.temp[1], '     '));
	etobiShield.display.writeLine(7, stringPad(displayStorage.temp[2], '     ') + '        ' + stringPad(displayStorage.temp[3], '     '));
};
